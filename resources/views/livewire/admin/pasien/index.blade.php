...
<div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-6 border-b border-gray-100 flex justify-between items-center">
        ...
        <div class="relative w-64">
            ...
            <input type="text" wire:model.live.debounce.500ms="search" placeholder="Cari nama pasien..." class="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all">
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-center">
                        <a href="/klinik/pasien/{{ $pasien->id }}" wire:navigate class="bg-white hover:bg-primary hover:text-white border border-primary text-primary font-bold px-4 py-2 rounded-xl text-xs transition-all inline-flex items-center shadow-sm">
