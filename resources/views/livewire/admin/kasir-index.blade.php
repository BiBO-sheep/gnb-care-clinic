...
<div class="space-y-6">
    ...
    @if(session('error'))
    <div class="bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-2xl font-body text-sm flex items-center gap-3">
    ...
    <div class="bg-yellow-50 rounded-3xl shadow-sm border border-yellow-200 overflow-hidden">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="bg-white rounded-2xl p-5 border border-yellow-100 shadow-sm">
                ...
                <form wire:submit.prevent="updateHargaObat({{ $inv->id }})">
                        ...
                        <div class="grid grid-cols-12 gap-2 items-center bg-gray-50 rounded-xl p-3">
                            ...
                            <div class="col-span-12 md:col-span-4">
                                <div class="relative">
                                    ...
                                    <input type="number" wire:model.defer="prices.{{ $pres->id }}" placeholder="Harga satuan" min="0" class="w-full bg-white border border-gray-200 rounded-xl pl-8 pr-3 py-2 text-sm outline-none focus:ring-2 focus:ring-primary/20" required>
                                </div>
                            </div>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center">
                            <button type="button" wire:click="konfirmasiLunas({{ $inv->id }})" class="bg-white hover:bg-primary hover:text-white border border-primary text-primary font-bold px-4 py-2 rounded-xl text-xs transition-all shadow-sm">
                                Konfirmasi Lunas
                            </button>
                        </td>
                    </tr>
