...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
            ...
            <div class="space-y-3">
                <a href="/klinik/queue" class="flex items-center gap-3 p-3 rounded-2xl hover:bg-primary-light group transition-all">
                    <div class="w-10 h-10 bg-primary-light group-hover:bg-primary rounded-xl flex items-center justify-center transition-colors">
                ...
                <a href="/klinik/kasir" class="flex items-center gap-3 p-3 rounded-2xl hover:bg-yellow-50 group transition-all">
                ...
                <a href="/klinik/doctor" class="flex items-center gap-3 p-3 rounded-2xl hover:bg-green-50 group transition-all">
                ...
                <a href="/klinik/pasien" class="flex items-center gap-3 p-3 rounded-2xl hover:bg-purple-50 group transition-all">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex items-center justify-between">
            ...
            <span class="bg-primary-light text-primary text-xs font-bold px-3 py-1 rounded-full">{{ $recentBookings->count() }} data</span>
        </div>
    ...
    {{-- ================================================================ --}}
    {{-- BARIS 4: LAPORAN KEUANGAN --}}
    {{-- ================================================================ --}}
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 border-b border-gray-100 flex items-center justify-between">
            <div>
                <h3 class="font-extrabold text-lg text-gray-800">Laporan Keuangan — Transaksi Lunas</h3>
                <p class="text-xs text-gray-400 mt-1">Rincian setiap transaksi yang sudah dikonfirmasi lunas.</p>
            </div>
            <span class="bg-green-100 text-green-700 text-xs font-bold px-3 py-1 rounded-full">{{ $paidInvoices->count() }} data</span>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 font-body">
                <thead class="text-xs text-gray-400 uppercase bg-gray-50">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="bg-white hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <p class="font-semibold text-gray-800">{{ $inv->user->name ?? '-' }}</p>
                        </td>
                        <td class="px-6 py-4 text-gray-600">
                            {{ $inv->appointment->poli->nama ?? '-' }}
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <span class="text-base font-extrabold text-gray-900">Rp {{ number_format($inv->grand_total, 0, ',', '.') }}</span>
                        </td>
                    ...
                    @empty
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center text-gray-400">Belum ada transaksi yang lunas.</td>
                    </tr>
                    @endforelse
                </tbody>
                ...
                <tfoot class="bg-primary-light border-t-2 border-primary/20">
                    <tr>
                        <td colspan="3" class="px-6 py-4 font-extrabold text-primary text-sm uppercase tracking-wider">Total Keseluruhan</td>
