...
@section('title', $isAdmin ? 'Pemantauan Dokter' : 'Dashboard Dokter')
@section('header', $isAdmin ? 'Pemantauan Ruang Dokter (Semua Poli)' : 'Ruang Dokter')
@section('subheader', $isAdmin ? 'Pantau semua aktivitas medis di setiap Poli secara real-time.' : 'Lihat pasien yang sudah dipanggil dan siap diperiksa.')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-2xl p-5 flex flex-col relative overflow-hidden shadow-sm">
                            ...
                            <div class="mt-auto relative z-10">
                                <a href="/klinik/doctor/examine/{{ $activePatient->id }}" class="block text-center bg-green-600 text-white py-2 rounded-xl font-bold text-xs hover:bg-green-700 transition-all">
                                    Lihat Detail / Status
                                </a>
                            </div>
                        </div>
                ...
                @if(isset($waitingPatients[$poliName]) && $waitingPatients[$poliName]->count() > 0)
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="bg-gray-50 rounded-2xl p-4 border border-gray-200 flex flex-col">
                            ...
                            <div class="mt-auto">
                                <a href="/klinik/doctor/examine/{{ $patient->id }}" class="block text-center bg-white border border-gray-300 text-gray-700 py-2 rounded-xl font-bold text-[10px] hover:bg-gray-100 transition-all">
                                    Lihat Data Pasien
                                </a>
                            </div>
                        </div>
